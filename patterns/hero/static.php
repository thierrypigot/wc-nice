...
<div class="wp-block-cover alignfull">
	...
	<div class="wp-block-cover__inner-container">
		...
		<p class="has-text-align-center">Join the WordPress community on the French Riviera for a day of talks, workshops, and networking. WordCamp Nice brings together developers, designers, and users in one of the Mediterranean's most vibrant cities.</p>
		<!-- /wp:paragraph -->
		...
		<div class="wp-block-buttons">
			...
			<!-- /wp:button -->
			<!-- wp:button {"className":"wp-block-button is-style-outline"} -->
			<div class="wp-block-button is-style-outline"><a class="wp-block-button__link wp-element-button">Sponsor the event</a></div>
			<!-- /wp:button -->
		</div>
		<!-- /wp:buttons -->
