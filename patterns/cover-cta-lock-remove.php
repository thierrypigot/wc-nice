<?php
/**
 * Title: Cover CTA — bouton verrouillé (suppression)
 * Slug: wc-nice/cover-cta-lock-remove
 * Categories: wordcamp-cta, banner, featured
 * Keywords: cover, cta, banner, call to action, register
 * Block Types: core/cover
 * Description: Cover banner with heading and action button (button cannot be removed)
 */
?>
...
<div class="wp-block-cover alignfull" style="padding-top:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--50)">
	...
	<div class="wp-block-cover__inner-container">
		...
		<div class="wp-block-buttons">
			<!-- wp:button {"backgroundColor":"base","textColor":"contrast","lock":{"move":false,"remove":true}} -->
